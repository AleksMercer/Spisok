...
function Mainpage() {
  ...
  return (
    <div className='mainpage'>
      ...
      <Card className={proboval.className} description={proboval.descriptionEN} picture={proboval.picture} button={proboval.button} urlpath={proboval.urlpath} />
      <Card className={garderob.className} description={garderob.descriptionEN} picture={garderob.picture} button={garderob.button} urlpath={garderob.urlpath} />
      <Card className={dela.className}     description={dela.descriptionEN}     picture={dela.picture}     button={dela.button}     urlpath={dela.urlpath} />

      <div class="designed"><span>- Site designed and created by <a href="https://github.com/AleksMercer">Mercer </a>© 2023 -</span></div>
